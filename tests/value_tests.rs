...
fn test_value_subtraction() {
    ...
    // Error cases
    assert!(Value::String("hello".to_string()).subtract(&Value::Number(1.0)).is_err());
...
fn test_value_multiplication() {
    ...
    // Error cases
    assert!(Value::String("hello".to_string()).multiply(&Value::Number(2.0)).is_err());
...
fn test_value_division() {
    ...
    // Error cases
    assert!(Value::String("hello".to_string()).divide(&Value::Number(2.0)).is_err());
...
fn test_value_modulo() {
    ...
    // Error cases
    assert!(Value::String("hello".to_string()).modulo(&Value::Number(2.0)).is_err());
...
fn test_value_comparisons() {
    ...
    assert!(Value::Number(10.0).greater_than(&Value::Number(5.0)).unwrap());
    assert!(!Value::Number(5.0).greater_than(&Value::Number(10.0)).unwrap());
    assert!(!Value::Number(5.0).greater_than(&Value::Number(5.0)).unwrap());
    
    // String comparisons
    assert!(Value::String("apple".to_string()).less_than(&Value::String("banana".to_string())).unwrap());
    assert!(!Value::String("banana".to_string()).less_than(&Value::String("apple".to_string())).unwrap());
    
    assert!(Value::String("banana".to_string()).greater_than(&Value::String("apple".to_string())).unwrap());
    assert!(!Value::String("apple".to_string()).greater_than(&Value::String("banana".to_string())).unwrap());
    
    // Error cases - cannot compare different types
    assert!(Value::Number(5.0).less_than(&Value::String("10".to_string())).is_err());
